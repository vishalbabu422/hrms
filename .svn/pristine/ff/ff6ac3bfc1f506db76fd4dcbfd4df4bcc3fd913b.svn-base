  ...
  useImperativeHandle(ref, () => ({
    submit: async () => {
      try {
        ...
        const employeePayload = clean(employeeDetails)
        const detailsPayload = clean(employeeExtraDetails)
        ...
        <CForm>
          <CRow className="g-3">
            ...
            <CCol md={6}>
              ...
              {errors.division && <div className="text-danger mt-1">{errors.division}</div>}
            </CCol>
