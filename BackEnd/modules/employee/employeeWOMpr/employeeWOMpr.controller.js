...
const uploadEmployeeWOMpr = catchAsync(async (req, res, next) => {
    ...
    const result = await sequelize.transaction(async (t) => {
        ...
        const employees = await service.getEmployeesByIds(employee_ids, wo_id);
...
//        const employees = await service.getEmployeesFullData(
//        employee_ids,
//        wo_id,
//        month,
//        year
...
//         // 🔹 Step 2: Generate ONE PDF
//         const { fileName, filePath } = await generateMprPdf(
//             employees.map(e => e.dataValues),
//             { month, year, wo_id }
//         );

//         // 🔹 Step 3: Insert record for EACH employee
