...
const EmpSalaryStructureForm = ({ onSubmit }) => {
    ...
    try {
      ...
      list.forEach((emp) => {
        ...
        prefillMap[emp.employee_id] = {
          checked: !!(emp.ctc || emp.effective_from),
          ...
          hasExistingSalary: !!(emp.ctc || emp.effective_from),
        }
      })
  ...
  const handleSubmit = (e) => {
    ...
    const finalData = Object.entries(selectedEmployees)
      ...
      .map(([id, v]) => ({
        ...
        ctc: Number(v.annual_ctc || 0),

        monthly_ctc: Number(v.monthly_ctc || 0),

        annual_ctc: Number(v.annual_ctc || 0),
  ...
  const handleMonthlyCtcChange = (id, value) => {
    const monthly = value
    ...
    setSelectedEmployees((prev) => ({
      ...
      [id]: {
        ...
        annual_ctc: monthly ? Number(monthly) * 12 : '',
      },
    }))
  }

  const handleAnnualCtcChange = (id, value) => {
    const annual = value
  ...
  return (
    <CForm onSubmit={handleSubmit}>
                ...
                <table className="table table-bordered align-middle">
                  <thead>
                    <tr>
                      ...
                      <th style={{ minWidth: '180px' }}>Monthly CTC</th>

                      <th style={{ minWidth: '180px' }}>Annual CTC</th>
      ...
      <IncrementModal
        ...
        onSave={(data) => {
          console.log('Increment Saved', data)
