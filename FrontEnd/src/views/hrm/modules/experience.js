...
import { validateExperience } from '../../../validations/experienceValidation'
  ...
  const removeExperience = async (exp, index) => {
    try {
      if (exp.id) {
        ...
        await api.delete(`/employee/${employeeId}/experiences/${exp.id}`)
