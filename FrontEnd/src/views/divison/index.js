                ...
                {loading ? (
                  ...
                  division.map((item) => (
                    <CTableRow key={item.id}>
                      <CTableDataCell>{item.division_name}</CTableDataCell>

                      <CTableDataCell>{item.division_code || '-'}</CTableDataCell>

                      <CTableDataCell>{item.parentDivisionName || '-'}</CTableDataCell>
                      ...
                      <CTableDataCell>
                        <div className="d-flex justify-content-center gap-2">
                          {/* <ActionButton
                            color="primary"
                            icon={cilDescription}
                            onClick={() => navigate(`/division/preview/${item.id}`)}
                          /> */}
                          <ActionButton
                            color="primary"
                            icon={cilPencil}
                            onClick={() => navigate(`/division/edit/${item.id}`)}
                          />
                          <ActionButton
                            color="danger"
                            icon={cilTrash}
